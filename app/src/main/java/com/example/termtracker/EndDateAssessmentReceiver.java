...
public class EndDateAssessmentReceiver extends BroadcastReceiver {
    private int NOTIFICATION_ID = 0;
    @Override
    public void onReceive(Context context, Intent intent) {
        String END_CHANNEL_ID = "assessment_end_ID";
        ...
        Notification EndNotification = new NotificationCompat.Builder(context, END_CHANNEL_ID)
                ...
                .setContentText(intent.getStringExtra("ASSESSMENT_ENDING"))
                .setAutoCancel(true)
                .build();
